...
const part3LeafCount = taxLawPart3Point01LeafCount + taxLawPart3Point02LeafCount
...
for (const pointId of ['p1s1', 'p1s2', 'p1s3', 'p2s1', 'p2s2', 'p2s3', 'p3s1', 'p3s2']) {
...
console.log(`PART 3 국세: ${expected.partGroups[2]} 중분류 · ${expected.partTopics[2]} 소분류 · leaf ${part3LeafCount}/${expected.partTopics[2]} 완료 (종합부동산세 25 + 종합소득세 29)`)
console.log(`전체 세부 학습카드: ${completedLeafCount}/${expected.topics}`)
console.log('POINT 본문: 9/9 존재 · 다음 leaf 확장 대상은 PART 3 POINT 03 양도소득세')
