...
export const exam37LawDifferences = {
  ...
  'brokerage-law': {
    ...
    summary: '공인중개사법의 2026.2.27 법률 개정은 제37회에 적용하고, 2026.6.1 이후의 시행령 후속정비는 비교 전용으로 분리합니다.',
    changes: [
      {
        law: '공인중개사법 제41조 등',
        amendment: '2026.2.27 일부개정 · 2026.8.28 시행',
        status: 'applied',
        before: '종전에는 “공인중개사협회”를 설립할 수 있도록 하는 임의적 협회 체계였습니다.',
        after: '“한국공인중개사협회”를 설립하도록 법정단체화하고 정관 인가, 중앙회·시도회·지회, 총회, 윤리규정, 공익활동 의무 등을 규정했습니다.',
        examImpact: '이 프로젝트는 시행일이 아니라 공포·개정일을 기준으로 하므로 2026.2.27 법률 개정을 제37회 본문에 적용합니다. 따라서 법률상 협회 명칭과 법정단체 구조는 개정 후 기준으로 학습합니다.',
        source: official('LSW/lsInfoP.do?lsiSeq=283713&viewCls=lsRvsDocInfoR'),
      },
      {
        law: '공인중개사법 시행령',
        amendment: '2026.8.18 일부개정 · 2026.8.28 시행',
        status: 'comparison',
        before: '시행령의 협회 관련 세부 규정은 종전 하위법령 체계를 따릅니다.',
        after: '2026.2.27 법률 개정에 맞추어 한국공인중개사협회의 법정단체 체계와 관련된 하위 규정을 정비했습니다.',
        examImpact: '시행령 자체의 2026.8.18 개정은 컷오프 이후이므로 해당 하위법령 세부 변경은 비교 전용입니다. 다만 2026.2.27에 이미 개정된 법률상 “한국공인중개사협회”와 법정단체화는 제37회 본문에 적용합니다.',
      ...
      },
      {
        ...
        after: '실무교육 45시간',
        examImpact: '2025년에 공포된 개정이므로 컷오프 이전입니다. 제37회 본문에서는 실무교육 45시간을 적용합니다.',
