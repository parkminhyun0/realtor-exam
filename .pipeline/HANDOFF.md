...
- PR **#33(배포 경로 단일화)** · **#34(규격 통일 파이프라인)** 는 모두 `main` 병합 완료.
  2026-08-27 09:00 KST 기준 열린 PR은 없다.
- PR #34 시운전용으로 남아 있던 `.pipeline/task1` · `.pipeline/task2` 산출물은
  운영 과제와 혼동되지 않도록 후속 정리에서 제거했다.
